        ...
        <Container>
          <Row className="mb-3">
            <Col className="logoAndParaCont">
              ...
              At our company, we take pride in offering premium outdoor tiles that 
              redefine the aesthetics and functionality of outdoor spaces. With a commitment 
              to quality and innovation, we specialize in providing 
              a diverse range of outdoor tiling solutions tailored to meet the unique needs of our customers.
              </p>
            </Col>
          </Row>
          ...
          <Row  style={{ margin:"10px", borderRadius:"8px", padding:"5px"}} >
            ...
            <div className="socialCont">
              ...
              <a
                href="https://www.facebook.com/ImanTilesFactory/"
                target="_blank"
                rel="noopener noreferrer"
              >
